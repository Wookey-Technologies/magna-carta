...
The two moderators from users must be active members and serve a 3 month term(subject to change if the community feels they are good at moderating) if they cannot fulfill there moderating duty for reason of taking break from sansar or quitting they must make notification they do not want the job anymore and must be replaced. the elected user, should keep the neutral ground balance, and act according to the laws. If needing to act alone every moderation must be done with proper documentation and careful attention. Notify the other moderators immediately. In general don't intimidate, dont bird Dog(watching over every user waiting for them to need moderation). Let the flow and peoples fun always be the priority. 
