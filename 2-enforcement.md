...
# 2.3.2 
Users may not engage in discussions about 3d modeling, how to animating, how to rigging, 3d tech talk in the official Sansar created welcome worlds for new users. Also they may not talk about their grievences with sansar in these worlds. This hurts sansar due to those areas are meant for welcoming new users to sansar. Conversations to new users of the possibilties of sansar through 3d is allowed but should be brief. Users should be encouraged to take that to  personal worlds or designated meeting places for that talk. Users should be encouraged to make a world for talking about "3d tech talk" that way its a known meeting place for users old and new to learn those things rather than discord.

Punishment will never be a permanent or temporary ban. Upon accusation with evidence moderation will privately message the offenders and ask them to leave to there experience if they want to talk about topic. The culture of sansar  needs to be that is the law and users are violating the law which is unacceptable, but not a bannable offense. It is an "educational offense" where the offending users need to educated that this does not help new users because tech talk may overwelm them.
